...
# NOTICE — PAXECT Link Plugin

Copyright (c) 2025 PAXECT Systems

This software constitutes the **PAXECT Link Plugin** —  
the deterministic, offline-first inbox/outbox bridge of the **PAXECT ecosystem**.  
...
**PAXECT™**, **PAXECT Link**, and the **PAXECT Systems** logo  
